...
// validate username
	...
	//SeleniumUtil.clickOnElement( driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div[2]/div[1]/button")));
	      
	// enter first name
	driver.findElement(By.cssSelector("input[placeholder='First Name']")).sendKeys("Suyog");

	// enter last name
	driver.findElement(By.cssSelector("input[placeholder='Last Name']")).sendKeys("Nimbhorkar");
